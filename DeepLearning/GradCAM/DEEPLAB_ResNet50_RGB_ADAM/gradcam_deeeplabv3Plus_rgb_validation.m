...
mainGradcamDir=fullfile(rootFolder,'GradCAM','DEEPLAB_ResNet50_RGB_ADAM');
...
fprintf('\nFinished generating Grad-CAM (DeepLabv3+) for all folds.\n');
...
function [imdsResized,pxdsResized]=loadAndProcessTestData(testFoldPath,classNames,labelIDs,inputSize)
    ...
    tempImageDir=fullfile(tempdir,'ProcessedImages_DeepLab');
    tempLabelDir=fullfile(tempdir,'ProcessedMasks_DeepLab');
